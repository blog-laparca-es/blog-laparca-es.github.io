var tinyMCEPreInit = { settings : { themes : "advanced", plugins : "safari,inlinepopups,autosave,spellchecker,paste,wordpress,media,fullscreen,wpeditimage", languages : "es", debug : false }, base : "http://blog.laparca.es/wp-includes/js/tinymce", suffix : "", query : "ver=311" };tinyMCEPreInit.start = function() {
...
clipboard_msg:"Copiar/cortar/Pegar no funciona en Morzilla y Firefox",
clipboard_no_support:"Actualmente no es compatible con su navegador, en su lugar puedes utiliza los métodos abreviados de teclado.",
popup_blocked:"Lo sentimos, pero hemos detectado que se han bloqueado las ventanas emergentes de la aplicación. Debes desactivar el bloqueo de ventanas emergentes en este sitio con el fin de utilizar plenamente esta herramienta.",
invalid_data:"Error: Los valores introducidos con incorrectos, han sido marcados en rojo.",
...
layer:{
insertlayer_desc:"Insertar imagen",
forward_desc:"Avanzar",
backward_desc:"Volver atrás",
...
nonbreaking:{
nonbreaking_desc:"Inserta un espacio"
},
iespell:{
...
advhr:{
advhr_desc:"Línea horizontal"
},
emotions:{
emotions_desc:"Caritas"
},
searchreplace:{
search_desc:"Buscar",
...
cite_desc:"Atención",
abbr_desc:"Abr",
acronym_desc:"Anónimo",
del_desc:"Borrar",
ins_desc:"Insertar",
attribs_desc:"Insertar/Editar atibutos"
},
style:{
desc:"Editar la Hoja CSS de estilos"
},
paste:{
paste_text_desc:"Pegar como texto plano",
paste_word_desc:"Pegar de Word",
...
row_before_desc:"Insertar fila antés",
row_after_desc:"Insertar fila después",
delete_row_desc:"Borrar Fila",
col_before_desc:"Insertar columna antés",
col_after_desc:"Insertar columna despues",
delete_col_desc:"Borrar columna",
split_cells_desc:"Dividir celdas combinadas de la tabla",
...
paste_row_before_desc:"Pegar la fila de la tabla antés",
paste_row_after_desc:"Pegar la fila de la tabla después",
cut_row_desc:"Cortar la fila de la tabla",
copy_row_desc:"Copiar la fila de la tabla",
del:"Borrar tabla",
row:"Fila",
col:"Columna",
cell:"Celda"
...
autosave:{
unload_msg:"Los cambios realizados se perderán si usted abre otra página en el navegador."
},
fullscreen:{
desc:"Cambiar a modo pantalla completa (Alt+Shift+G)"
},
media:{
desc:"Insertar / editar multimedia incorporada",
delta_width:"0",
delta_height:"0",
edit:"Editar multimedia incorporada"
},
fullpage:{
...
spellchecker:{
desc:"Seleccionar el corrector ortográfico (Alt+Shift+N)",
...
justifyleft_desc:"Alineación izquierda (Alt+Shift+L)",
justifycenter_desc:"Alineación al centro (Alt+Shift+C)",
justifyright_desc:"Alineación derecha (Alt+Shift+R)",
justifyfull_desc:"Alinear todo (Alt+Shift+J)",
bullist_desc:"Lista desordenada (Alt+Shift+U)",
numlist_desc:"Lista ordenada (Alt+Shift+O)",
outdent_desc:"Quitar cita/sangría",
indent_desc:"Cita",
...
link_delta_width:"0",
link_delta_height:"0",
unlink_desc:"Desenlazar (Alt+Shift+S)",
image_desc:"Insertar/Editar imagen (Alt+Shift+M)",
image_delta_width:"0",
image_delta_height:"0",
cleanup_desc:"Eliminar el código innecesario",
code_desc:"Editar el HTML fuente",
sub_desc:"Subscript",
sup_desc:"Superscript",
hr_desc:"Insertar una lina horizontal",
removeformat_desc:"Borrar Formato",
forecolor_desc:"Seleccionar un color de texto",
backcolor_desc:"Selecciona el color del fondo",
charmap_desc:"Insertar un carácter personalizado",
visualaid_desc:"Mostar líneas guía/elementos invisibles",
...
clipboard_msg:"Copiar/cortar/Pegar no funciona en Morzilla y Firefox",
path:"Ruta",
newdocument:"¿Seguro que quieres borrar todos los comentarios?",
...
about_title:"Qué es TinyMCE",
about_general:"Información",
about_help:"Ayuda",
...
link_is_email:"La URL especificada parece ser un correo electrónico, ¿quiere añadir el prefijo mailto:?",
link_is_external:"La URL especificada parece ser un enlace externo, ¿quiere añadir el prefijo http://?",
link_list:"Listado de Enlaces"
});

tinyMCE.addI18n("es.media_dlg",{
title:"Insertar / editar multimedia incorporada",
general:"General",
advanced:"Avanzado",
file:"Archivo/URL",
list:"Lista",
...
playeveryframe:"Reproducir en cualquier frame",
targetcache:"Target del caché",
correction:"No hacer nada",
enablejavascript:"Activar JavaScript",
starttime:"Hora de inicio",
endtime:"Hora de finalización",
href:"Href",
qtsrcchokespeed:"Velocidad de ajuste",
target:"Target",
volume:"Volume",
autostart:"Auto inicio",
enabled:"Activado",
fullscreen:"Tamaño completo",
invokeurls:"Invocar URLs",
mute:"Silenciar",
stretchtofit:"Ajustar hasta encajar",
windowlessvideo:"Vídeo sin ventana",
balance:"Balance",
baseurl:"URL base",
captioningid:"Subtítulos ID",
currentmarker:"Marcado actual",
currentposition:"Situación actual:",
defaultframe:"Frame predeterminado",
playcount:"Contar el juego",
rate:"Ratio",
uimode:"Modo UI",
flash_options:"Opciones del Flash",
qt_options:"Opciones de Quicktime",
wmp_options:"Opciones de del reproductor Windows media",
rmp_options:"Opciones de Real media player",
shockwave_options:"Preferencias opcionales",
autogotourl:"Ir automaticamente a la URL",
center:"Centrar",
imagestatus:"Estado de estado",
maintainaspect:"Mantener las proporciones",
nojava:"Sin java",
prefetch:"Prefetch",
shuffle:"Programada",
console:"Consola",
numloop:"Bucles numericos",
controls:"Controles",
scriptcallbacks:"Script de repeticiones",
swstretchstyle:"Ajuste del Estilo",
swstretchhalign:"Ajustar la alineación horizontal",
swstretchvalign:"Ajustar la alineación vertical",
sound:"Sonido",
progress:"Progeso",
qtsrc:"QT Src",
qt_stream_warn:"Los recursos Rtsp deben añadirse en el campo QT Src en la pestaña de Opciones avanzadas.",
align_top:"Arriba",
align_right:"Derecha",
align_bottom:"Abajo",
align_left:"Izquierda",
align_center:"Centrar",
align_top_left:"Arriba izquierdo",
align_top_right:"Arriba derecha",
align_bottom_left:"Inferior izquierdo",
align_bottom_right:"Inferior derecho",
flv_options:"Opciones del video Flash",
flv_scalemode:"Escala del Modo",
flv_buffer:"Buffer",
flv_startimage:"Imagen de inicio",
flv_starttime:"Hora de inicio",
flv_defaultvolume:"Volumen Predeterminado",
flv_hiddengui:"GUI oculto",
flv_autostart:"Auto inicio",
flv_loop:"Loop",
flv_showscalemodes:"Mostrar las escalas de los modos",
...
add_media:"Adjuntar Multimedia",
add_image:"Adjuntar una Imagen",
add_video:"Adjuntar Video",
add_audio:"Adjuntar Audio"
});
...
link_help:"Introduzca un enlace URL o haga clic encima de presets.",
...
tinyMCE.init({mode:"none",onpageload:"wpEditorInit",width:"100%",theme:"advanced",skin:"wp_theme",theme_advanced_buttons1:"bold,italic,strikethrough,|,bullist,numlist,blockquote,|,justifyleft,justifycenter,justifyright,|,link,unlink,wp_more,|,spellchecker,fullscreen,wp_adv",theme_advanced_buttons2:"formatselect,underline,justifyfull,forecolor,|,pastetext,pasteword,removeformat,|,media,charmap,|,outdent,indent,|,undo,redo,wp_help",theme_advanced_buttons3:"",theme_advanced_buttons4:"",language:"es",spellchecker_languages:"+English=en,Danish=da,Dutch=nl,Finnish=fi,French=fr,German=de,Italian=it,Polish=pl,Portuguese=pt,Spanish=es,Swedish=sv",theme_advanced_toolbar_location:"top",theme_advanced_toolbar_align:"left",theme_advanced_statusbar_location:"bottom",theme_advanced_resizing:"1",theme_advanced_resize_horizontal:"",dialog_type:"modal",relative_urls:"",remove_script_host:"",convert_urls:"",apply_source_formatting:"",remove_linebreaks:"1",paste_convert_middot_lists:"1",paste_remove_spans:"1",paste_remove_styles:"1",gecko_spellcheck:"1",entities:"38,amp,60,lt,62,gt",accessibility_focus:"",tab_focus:":next",content_css:"http://blog.laparca.es/wp-includes/js/tinymce/wordpress.css",save_callback:"switchEditors.saveCallback",wpeditimage_disable_captions:"",plugins:"safari,inlinepopups,autosave,spellchecker,paste,wordpress,media,fullscreen,wpeditimage"});